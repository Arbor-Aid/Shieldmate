...
SERVICE_NAME = os.getenv("MCP_SERVICE_NAME", os.getenv("SERVICE_NAME", os.getenv("SERVICE_SLUG", "investment_recommendation")))
SERVICE_SLUG = os.getenv("SERVICE_SLUG", "investment_recommendation")
