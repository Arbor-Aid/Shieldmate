...
SERVICE_NAME = os.getenv("SERVICE_NAME", "Content Generation Ai")
SERVICE_SLUG = os.getenv("SERVICE_SLUG", "content-generation-ai")
SERVICE_DESCRIPTION = os.getenv("SERVICE_DESCRIPTION", "Contract-first skeleton service for content-generation-ai.")
SERVICE_VERSION = (
