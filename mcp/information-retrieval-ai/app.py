...
SERVICE_NAME = os.getenv("SERVICE_NAME", "Information Retrieval Ai")
SERVICE_SLUG = os.getenv("SERVICE_SLUG", "information-retrieval-ai")
SERVICE_DESCRIPTION = os.getenv("SERVICE_DESCRIPTION", "Contract-first skeleton service for information-retrieval-ai.")
SERVICE_VERSION = (
