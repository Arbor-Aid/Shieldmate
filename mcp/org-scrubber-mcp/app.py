...
SERVICE_NAME = os.getenv("SERVICE_NAME", "Org Scrubber Mcp")
SERVICE_SLUG = os.getenv("SERVICE_SLUG", "org-scrubber-mcp")
SERVICE_DESCRIPTION = os.getenv("SERVICE_DESCRIPTION", "Contract-first skeleton service for org-scrubber-mcp.")
SERVICE_VERSION = (
