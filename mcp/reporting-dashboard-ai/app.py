...
SERVICE_NAME = os.getenv("SERVICE_NAME", "Reporting Dashboard Ai")
SERVICE_SLUG = os.getenv("SERVICE_SLUG", "reporting-dashboard-ai")
SERVICE_DESCRIPTION = os.getenv("SERVICE_DESCRIPTION", "Contract-first skeleton service for reporting-dashboard-ai.")
SERVICE_VERSION = (
