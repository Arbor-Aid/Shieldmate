...
SERVICE_NAME = os.getenv("SERVICE_NAME", "Data Scrubbing Ai")
SERVICE_SLUG = os.getenv("SERVICE_SLUG", "data-scrubbing-ai")
SERVICE_DESCRIPTION = os.getenv("SERVICE_DESCRIPTION", "Contract-first skeleton service for data-scrubbing-ai.")
SERVICE_VERSION = (
