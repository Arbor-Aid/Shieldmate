...
SERVICE_NAME = os.getenv("SERVICE_NAME", "Ai Training Coordinator")
SERVICE_SLUG = os.getenv("SERVICE_SLUG", "ai-training-coordinator")
SERVICE_DESCRIPTION = os.getenv("SERVICE_DESCRIPTION", "Contract-first skeleton service for ai-training-coordinator.")
SERVICE_VERSION = (
