...
SERVICE_NAME = os.getenv("MCP_SERVICE_NAME", os.getenv("SERVICE_NAME", os.getenv("SERVICE_SLUG", "tradefinance_lc")))
SERVICE_SLUG = os.getenv("SERVICE_SLUG", "tradefinance_lc")
